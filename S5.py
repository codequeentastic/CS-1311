...
# The attached file S5-Input.txt contains a long list of random numbers.
...
def main():
    ...
    try:
        # Open the files
        infile = open('S5-Input.txt', 'r')
        outfile = open('S5-Output.txt', 'w')
        ...
        outfile.writelines('<--------- PROGRAMMING ASSIGNMENT 5: Output Results --------->' + '\n\n')
